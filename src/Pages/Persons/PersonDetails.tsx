...
function PersonDetails() {
  ...
  useEffect(() => {
    axios(
      `https://api.themoviedb.org/3/person/${cast_id}?api_key=f23d45e024dfa841dbe4c5648bd1a790&language=tr|en`
    )
      .then((res) => res.data)
  ...
  return (
    <div className="md:py-8 bg-slate-900 text-slate-100 px-4 flex">
      <img
        loading="lazy"
        src={`${
